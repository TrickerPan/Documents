...
|1.3.0|2017.9.25|增加单元测试规约(PDF 终极版), 阿里开源的 IDE 代码规约检测插件: [点此下载](https://github.com/alibaba/p3c) 更多及时信息, 请关注《阿里巴巴 Java 开发手册》官方公众号: ![公众号二维码](/static/images/manual_qrcode.jpg)|
